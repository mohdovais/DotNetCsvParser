...
public class CsvParse_ParseShould
{
    ...
    {
        var parsed = CsvParser.ParseFile(Path.Join(Directory.GetCurrentDirectory(), "files", "Sample-Spreadsheet-1.csv"));
    ...
    {
        var parsed = CsvParser.ParseFile(Path.Join(Directory.GetCurrentDirectory(), "files", "Sample-Spreadsheet-2.csv"));
    ...
    {
        var parsed = CsvParser.ParseFile(Path.Join(Directory.GetCurrentDirectory(), "files", "Sample-Spreadsheet-59507-rows.csv"));
    ...
    public void CsvParse_Should_parse_complex_csv()
    {
        ...
        var actual = CsvParser.ParseFile(Path.Join(Directory.GetCurrentDirectory(), "files", "Wikipedia-Example.csv"));
